...
class UseCasesSignUpRepository implements UseCase<Either<ApiError, Output>, NoParams> {
  final AuthSignupRepository authSignupRepository;

  UseCasesSignUpRepository({required this.authSignupRepository});
  @override
  Future<Either<ApiError, Output>> call(NoParams params) {
    return authSignupRepository.postUserSignUpInformation();
